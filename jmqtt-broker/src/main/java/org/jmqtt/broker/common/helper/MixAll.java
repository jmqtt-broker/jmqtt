...
public class MixAll {
    ...
    public static String MQTT_VERSION_SUPPORT = "mqtt,mqttv3.1,mqttv3.1.1,mqtt5.0";
    ...
    public static <T> T pluginInit(Class<T> clazz) {
        try {
    ...
    public static <T> T pluginInit(String classFullName, Class<?>[] classes, Object... args) {
        try {
            Class<?> clazz = Class.forName(classFullName);
