...
public interface InflowMessageMapper extends Mapper<InflowMessageDO> {
    ...
    @Insert("<script>" +
            ...
            "</if>" +
            "<if test=\"'${dbType}' != 'oracle'\">" +
            "INSERT INTO jmqtt_inflow_message(id, client_id,msg_id,content,gmt_create) " +
            "VALUES(#{id},#{clientId},#{msgId},#{content},#{gmtCreate})" +
