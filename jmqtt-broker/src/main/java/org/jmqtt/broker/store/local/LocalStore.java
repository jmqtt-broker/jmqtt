...
public class LocalStore {
    ...
    private static final LocalStore localStore = new LocalStore();
        ...
        if (this.start.compareAndSet(false, true)) {
            ...
            this.dataSource = new DataSourceFactory() {
                ...
                public DataSource getDataSource() {
                    ...
                    dds.setDriverClassName(brokerConfig.getLocalStoreDriver());
                    dds.setUrl(brokerConfig.getLocalStoreUrl());
                    dds.setUsername(brokerConfig.getLocalStoreUsername());
                    dds.setPassword(brokerConfig.getLocalStorePassword());
