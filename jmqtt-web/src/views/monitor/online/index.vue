    ...
    <div class="app-container">
        ...
        >
            ...
            <el-table-column label="状态" align="center" prop="state" :show-overflow-tooltip="true" width="80">
                <template #default="scope">
                    <el-tooltip effect="dark" content="CleanStart = false，在线 -> 离线 -> 过期；CleanStart = true，在线 -> 过期" placement="top">
                        <span>
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
                <template #default="scope">
                    <el-button link type="primary" icon="View" @click="clientDetail(scope.row.clientId)">详情</el-button>
                    <el-button v-if="scope.row.state === 'ONLINE'" link type="danger" icon="Delete"
                               @click="handleForceLogout(scope.row)">强踢
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script setup name="Online">
    ...
    function clientDetail(clientId) {
        router.push('/monitor/online-detail/index/' + clientId)
    }
